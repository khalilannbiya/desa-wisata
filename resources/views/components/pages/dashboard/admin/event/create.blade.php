<x-layouts.dashboard>
    ...
    <form action="{{ route(auth()->user()->role . '.events.store') }}" enctype="multipart/form-data" method="POST">
        @csrf
        @method('POST')

        <div class="">
            <div class="">
                <h1 class="mb-6 text-xl font-bold text-black-dashboard dark:text-white-dahsboard">Tambah Acara
                </h1>
            </div>
            ...
            <div class="px-6 py-6 mb-6 bg-white rounded-lg shadow-lg dark:bg-black">
                ...
                <input type="file" required accept="image/*" name="image" id="image" class="mt-3">
            ...
            <div class="px-6 py-6 mb-6 bg-white rounded-lg shadow-lg dark:bg-black">
                ...
                <div class="mb-4.5">
                    ...
                    <input required id="start_date"
                        ...
                        type="datetime-local" name="start_date" value="{{ old('start_date') }}"
                        min="{{ date('Y-m-d\TH:i') }}">
                </div>
                ...
                <div class="mb-4.5">
                    ...
                    <input required id="end_date"
                        class="rounded border-[1.5px] border-black bg-transparent px-5 py-3 font-normal text-black outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary"
                        type="datetime-local" name="end_date" value="{{ old('end_date') }}"
                        min="{{ date('Y-m-d\TH:i') }}">
                </div>
                ...
                <div class="w-full mb-6 ">
                    ...
                    <input name="location" id="location" value="{{ old('location') }}" autocomplete="location"
