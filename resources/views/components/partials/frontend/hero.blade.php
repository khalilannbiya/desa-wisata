        ...
        <div class="mr-auto place-self-center lg:col-span-7">
            ...
            <div class="space-y-4 sm:flex sm:space-y-0 sm:space-x-4">
                <a href="{{ route('destinations') }}"
                    class="inline-flex justify-center px-4 py-2 text-base font-medium text-center text-white rounded bg-green-new hover:bg-opacity-90 focus:ring-4 focus:ring-purple-300 ">TEMPAT
                    WISATA</a>
            </div>
        </div>
