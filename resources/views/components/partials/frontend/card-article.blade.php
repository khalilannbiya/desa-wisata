        ...
        <div class="max-w-sm shadow-lg border-2 rounded-md ">
            ...
            <div class="text-center">
                <a href="#"
                    class="my-6 inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-deep-koamaru-600 rounded hover:bg-deep-koamaru-500 focus:ring-4 focus:outline-none focus:ring-blue-300 ">
                    Detail Artikel
