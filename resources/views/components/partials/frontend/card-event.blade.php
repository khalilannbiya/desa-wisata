<div
    ...
    <div
        ...
        <h1 class="elips font-inter text-3xl font-bold text-white">Kesenin Tradisi</h1>
        <p
        ...
        <button
            class="rounded-md bg-green-new px-3.5 py-2 font-com text-sm capitalize text-white shadow shadow-black/60">Selengkapnya</button>
    </div>
</div>
