<div class="max-w-screen-xl font-montserrat px-4 py-8 mx-auto space-y-12 lg:space-y-20 lg:py-20 lg:px-6">
    ...
    <div class="items-center gap-8 lg:grid lg:grid-cols-2 xl:gap-16">
        <div class="text-gray-700 sm:text-lg ">
            ...
            <p>Desa Sukarame berasal dari dua suku kata yaitu "suka" dan "rame". Konon menurut cerita rakyat bahwa
            ...
            <a href="#"
                class="inline-flex mt-3 items-center px-3 py-2 text-sm font-medium text-center text-white bg-deep-koamaru-600 rounded hover:bg-deep-koamaru-500 focus:ring-4 focus:outline-none focus:ring-blue-300 ">
                Selengkapnya
        ...
        <img class="hidden w-full mb-4 rounded-lg lg:mb-0 lg:flex" src="{{ asset('assets/img/dummy-vilage.jpg') }}"
