...
<body>
    <div class="">
        <div class="flex min-h-[100dvh] flex-col items-center justify-center bg-background px-4 text-center">
            <div class="space-y-4">
                <h1 class="font-bold tracking-tighter text-8xl text-green-new">403</h1>
                <p class="text-2xl font-bold text-muted-foreground">Oops, Anda tidak memiliki izin untuk mengakses
                    halaman ini.
                </p>
